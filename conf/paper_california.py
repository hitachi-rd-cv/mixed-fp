...
def get_config():
    ...
    num_epochs = 1000
    name_dataset = 'california_regression'
    input_dim = 8
    device = 'cuda'
    n_train = 5000
    n_val = 5000
    ...
    depth = 10000
    scale = 1e-1
    name_hyper_model = "meta"
    option_model = {'scale_reg': scale_reg}
    kwargs_hyper = {'beta': 0.1}
    dtype = 'float'
    kwargs_method = {}
    option_oracle = {}
    ...
    param_dict = {
        ...
        MainBilevelOptimizationStep.task_family: {
            "num_outer_steps": 100,
            "lr_outer": 0.01,
            "lr_inner": 0.01,
            "num_inner_steps": 100,
